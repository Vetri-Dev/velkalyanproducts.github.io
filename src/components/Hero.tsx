...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-background via-muted to-card">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 -left-32 w-80 h-80 bg-gradient-to-br from-accent/20 to-primary/20 rounded-full blur-3xl animate-float" style={{animationDelay: '3s'}}></div>
        <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-gradient-to-br from-primary/15 to-accent/15 rounded-full blur-3xl animate-float" style={{animationDelay: '1.5s'}}></div>
      </div>
          ...
          <div className="max-w-2xl mx-auto lg:mx-0 space-y-10 animate-fade-in">
            <div className="space-y-6">
              ...
              <h1 className="font-heading font-bold tracking-tight">
                <span className="block text-foreground">Precision Tools for</span>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Button 
                className="h-14 px-8 btn-gradient text-primary-foreground font-semibold rounded-xl neon-glow hover:shadow-cyber transform transition-all duration-300 hover:scale-105 relative overflow-hidden group"
            ...
            <div className="cyber-card rounded-3xl overflow-hidden shadow-cyber p-8 border border-primary/30 relative">
              ...
              <div className="relative z-10">
                <div className="text-center mb-8">
                  ...
                  <p className="text-muted-foreground">Engineered for Honda Quality Standards</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div 
                      key={tool.name}
                      className="flex flex-col items-center p-6 cyber-card rounded-2xl shadow-card hover:shadow-cyber transform transition-all duration-300 hover:scale-105 group border border-primary/20"
