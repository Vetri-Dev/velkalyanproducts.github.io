...
const Navbar = () => {
  ...
  return <header className="sticky top-0 z-50 w-full bg-white shadow-sm">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 bg-violet-950">
      ...
      {/* Mobile menu */}
      <div className={cn("md:hidden fixed inset-x-0 top-16 bg-white shadow-md transition-all duration-300 ease-in-out z-40", isMenuOpen ? "max-h-screen opacity-100" : "max-h-0 opacity-0 pointer-events-none")}>
        <div className="px-4 py-6 space-y-4">
          <a href="#products" className="block py-2 px-4 text-velkalyan-blue hover:bg-velkalyan-light rounded-md" onClick={() => setIsMenuOpen(false)}>
            Products
          </a>
          <a href="#about" className="block py-2 px-4 text-velkalyan-blue hover:bg-velkalyan-light rounded-md" onClick={() => setIsMenuOpen(false)}>
            About Us
          </a>
          <a href="#contact" className="block py-2 px-4 text-velkalyan-blue hover:bg-velkalyan-light rounded-md" onClick={() => setIsMenuOpen(false)}>
            Contact
          </a>
